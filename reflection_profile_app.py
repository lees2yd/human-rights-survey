...
IRB_APPROVAL_NO = "배포 전 IRB 승인번호 입력"
PRINCIPAL_INVESTIGATOR = "이성덕"
RESEARCH_CONTACT = "배포 전 연구자 연락처 입력"
DATA_RETENTION = "배포 전 IRB 승인 연구계획서상의 보유기간 입력"
...
이 연구는 교정공무원의 인권 관련 직무판단을 감(정서적·상황적 인식), 수(규범적·전문적 판단), 성(성찰적 점검·조정)의 관점에서 살펴보고, 25문항 척도의 요인구조와 신뢰도 및 교육적 활용 가능성을 후속 검증하는 데 목적이 있습니다.
