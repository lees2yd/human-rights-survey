...
st.markdown("""
본 연구는 교정 현장에서 근무하는 교도관을 대상으로 인권감수성의 특성과 교육적 함의를 탐색하기 위한 연구입니다.  
아래 내용을 충분히 읽고 이해하신 후, 연구 참여 여부를 자발적으로 결정해 주시기 바랍니다.

**연구 목적**  
본 설문은 감정 이해(감), 헌법적 기준의 수용(수), 성찰적 판단(성)을 중심으로 인권감수성의 구조를 분석하기 위한 연구 자료를 수집하는 것을 목적으로 합니다.

**연구 절차**  
본 설문은 총 27문항으로 구성되어 있으며, 4점 리커트 척도로 응답하게 됩니다. 응답에는 약 ○분 정도가 소요됩니다.

**개인정보 보호**  
본 설문은 익명으로 진행되며, 개인을 식별할 수 있는 정보는 수집하지 않습니다. 모든 자료는 연구 목적에 한하여 사용됩니다.

**자발적 참여**  
본 연구 참여는 전적으로 자발적이며, 언제든지 불이익 없이 참여를 중단할 수 있습니다.
""")

agree = st.checkbox("위 내용을 충분히 이해하였으며, 연구 참여에 자발적으로 동의합니다.")

if not agree:
    st.warning("연구 참여에 동의하셔야 설문을 진행할 수 있습니다.")
    st.stop()
