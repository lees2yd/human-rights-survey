...
TYPE_TEXT_MAIN = {
    "balance": """✅ 균형형
감·수·성 3요인이 비교적 고르게 나타난 유형입니다. 감정 인식(감), 기준 적용(수), 성찰(성)이 함께 작동하는 경향을 시사합니다.""",
    "emotion": """✅ 감우수형
감(감정 인식·공감) 축이 상대적으로 높은 유형입니다. 현장에서 사람의 감정 신호를 비교적 잘 포착하는 경향이 반영될 수 있습니다.""",
    "norm": """✅ 수우수형
수(기준·절차·비례성) 축이 상대적으로 높은 유형입니다. 규정·기준을 중심으로 판단을 정리하려는 경향이 반영될 수 있습니다.""",
    "reflect": """✅ 성우수형
성(성찰·자기점검) 축이 상대적으로 높은 유형입니다. 사건 이후 자신의 판단을 되돌아보는 경향이 반영될 수 있습니다.""",
    "normal": """✅ 보통형
총점이 ‘중간 미만’으로 나타난 경우입니다. 개인을 평가하기 위한 판정이 아니라, 현재 조건에서 감·수·성이 충분히 작동하기 어려웠을 가능성을 보여주는 신호로 해석할 수 있습니다."""
}

TYPE_TEXT_MH = {
    "balance": """✅ (정신질환 상황) 균형형
정신질환 수용자 상황에서도 감·수·성이 비교적 고르게 작동하는 유형입니다.""",
    "emotion": """✅ (정신질환 상황) 감우수형
정신질환 상황에서 감(정서 인식·공감) 축이 상대적으로 높은 유형입니다.""",
    "norm": """✅ (정신질환 상황) 수우수형
정신질환 상황에서 수(기준·절차·비례성) 축이 상대적으로 높은 유형입니다.""",
    "reflect": """✅ (정신질환 상황) 성우수형
정신질환 상황에서 성(성찰·자기점검) 축이 상대적으로 높은 유형입니다.""",
    "normal": """✅ (정신질환 상황) 보통형
정신질환 9문항 총점이 ‘중간 미만’으로 나타난 경우입니다. 이 영역은 사건 난이도·지원 자원·경험 여부의 영향을 크게 받습니다."""
}
...
if st.session_state.page == "cover":
    ...
    st.markdown("""
이 설문은 **감정 – 기준 – 성찰**의 상호작용을 바탕으로,  
교정현장에서 인권 관련 상황을 **어떤 방식으로 판단하는지**를 살펴보기 위한 도구입니다.

- 익명 설문이며 인사평가와 무관합니다.
- 이름·소속 등 개인정보를 수집하지 않습니다.
- 결과는 **점수 + 유형(보통형/4유형)** 중심으로 요약 제공됩니다.
