...
이 설문은 개인을 평가하기 위한 목적이 아니며,  
**교정현장의 판단 구조를 이해하고, 실천 가능한 인권감수성 지표를 개발하기 위함**입니다.

### 🧭 이 설문에서 확인할 수 있는 것
- 인권이 문제되는 상황을 나는 어떤 **방식으로 판단**하고 있는가?
- 나의 **감정·기준·성찰은 어떤 관계 구조**로 작동하고 있는가?
- **정신건강 문제가 있는 수용자**를 대할 때 나의 감수성 구조는 어떻게 달라지는가?

---

### 🔒 안전하고 익명
- 인사평가와 무관하며 이름·소속 등 개인정보를 수집하지 않습니다.
